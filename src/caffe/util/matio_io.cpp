...
#include "caffe/util/matio.h"
#include "caffe/util/matio_io.hpp"

namespace caffe {

template <typename Dtype> matio_types matio_type_map();
template <> matio_types matio_type_map<float>() { return MAT_T_SINGLE; }
template <> matio_types matio_type_map<double>() { return MAT_T_DOUBLE; }
template <> matio_types matio_type_map<int>() { return MAT_T_INT32; }
template <> matio_types matio_type_map<unsigned int>() { return MAT_T_UINT32; }

template <typename Dtype> matio_classes matio_class_map();
template <> matio_classes matio_class_map<float>() { return MAT_C_SINGLE; }
template <> matio_classes matio_class_map<double>() { return MAT_C_DOUBLE; }
template <> matio_classes matio_class_map<int>() { return MAT_C_INT32; }
template <> matio_classes matio_class_map<unsigned int>() { return MAT_C_UINT32; }
